...
import './js/component/title-app.js'
import './js/component/add-note.js'
import './js/component/notes-list.js'
import './js/component/archive-list.js'
...
document.addEventListener('DOMContentLoaded', async function () {
  ...
  const noteForm = addNoteElement
    ? addNoteElement.querySelector('#noteForm')
    : null
    ...
    archiveBtn.addEventListener('click', async function () {
      ...
      if (success) {
        if (isArchiving) {
          ...
          if (
            document.getElementById('archivedNoteList').contains(noteElement)
          ) {
            gsap.to(noteElement, {
              opacity: 0,
              y: -20,
